...
;Feel free to do anything you want with this code, consider it Public Domain
    ...
    .import _ppu_macro_len,_ppu_macro
...
irq:
    ...
    ; Waste a little bit of time here - this is to delay when we set the
    ; scroll registers into the HBLANK time so we don't get jumpy scroll
    ; effects from setting the registers in the middle of rendering.
    ;
    ; This value was measured empirically by hacking up an emulator and
    ; watching for interrupt acknowledge times.
    ldx #17
irq_wait:
    dex
    bne irq_wait
